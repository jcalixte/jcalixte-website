...
[Ajouter une image de bacs rouges]
...
- Parler de mon expérience sur un mauvais management et comment j'en suis aujourd'hui
- Que c'était pas ma personnalité de gérer un projet
- Et que j'étais bien loin d'imaginer être dans le management
- Et que maintenant je cherche à faire en sorte que tout le monde soit épanoui au travail
...
- Linkedin : Le management visuel améliore l'efficacité des équipes. @Julien vous propose dans cet article comment on peut commencer à en créer un étape par étape sur un projet.
